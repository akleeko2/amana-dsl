...
//
// ⚠️  هذا الملف هو المصدر الوحيد (SSoT) لأنماط أمانة الأساسية.
// تعديل هذه الأنماط يؤثر بصريًا على جميع التطبيقات المُولَّدة.
// بعد أي تعديل، شغّل: npm run visual:test
//
// هذا الملف يستبدل التكرار الموجود في:
//   - src/codegen/express.rs          (const BASE_CSS_CLASSES)
//   - src/codegen/express/views.rs    (const BASE_CSS_CLASSES)
//   - src/codegen/express/static_files/engine.rs  (CSS مضمّن في raw string)
